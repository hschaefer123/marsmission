sap.ui.define([
	...
	return BaseController.extend("de.uniorg.martian.controller.App", {
        ...
        onInit : function() {
            ...
            /*
            var bPlayAudio = this.oStorage.get("playAudio");
            this._setAudioState((bPlayAudio === null) ? false : bPlayAudio);
            */
			...
			//oRouter.getRoute("dashboard").attachPatternMatched(this._onDashboardRoute, this);
			//this._parallaxify();
        },	    
