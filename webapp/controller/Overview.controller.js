	...
	return BaseController.extend("de.uniorg.martian.controller.Overview", {
        ...
        updateData : function() {
            ...
            oUiModel.setProperty("/C3ChartData", [
                ["IN", this.getRandomNumber(20,40), this.getRandomNumber(20,40), this.getRandomNumber(20,40), this.getRandomNumber(20,40), this.getRandomNumber(20,40)],
                ["OUT", this.getRandomNumber(0,15), this.getRandomNumber(0,15), this.getRandomNumber(0,15), this.getRandomNumber(0,15), this.getRandomNumber(0,15)]
            ]);
